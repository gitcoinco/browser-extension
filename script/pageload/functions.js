...
getBountiesForRepo = function(github_url, callback) {
...
var addBountyInfoToIssuePage = function(url) {
  getBountiesForRepo(url,function(all_bounties){
...
var injectGetNumberBounties = function(repoURL) {
  ...
  var bounties = getBountiesForKeyword(repoKeyword, function(bounties){
