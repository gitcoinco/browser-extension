...
<Block {...styled}>
  <Box>
    <Field name="searchPersonName" placeholder="Person Name" component={ReduxField} type="text" />
    <Field name="searchPersonAlias" placeholder="Alias(Codename)" component={ReduxField} type="text" mt={[10]} />
  </Box>
  <Box mt={10} >
