...
<Block {...styled}>
  <Box>
    <Field name="searchEventName" placeholder="Name" component={ReduxField} type="text" />
    <Field name="searchEventAlias" placeholder="Alias" component={ReduxField} type="text" mt={[10]} />
  </Box>
  <Box mt={10} >
