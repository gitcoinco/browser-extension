...
<Block {...styled}>
  <Box>
    <Field name="searchProductName" placeholder="Product Name" component={ReduxField} type="text" />
    <Field name="searchProductAlias" placeholder="Alias(Codename)" component={ReduxField} type="text" mt={[10]} />
  </Box>
  <Box mt={10} >
