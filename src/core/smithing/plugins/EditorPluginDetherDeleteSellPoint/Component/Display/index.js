...
import DetherDeleteSellPointForm from 'assimilation/fetching/dether/DetherDeleteSellPointForm'
/* ---------------------------- Module Package ------------------------------ */
...
>
  ...
  <Flex align='center' >
    ...
    <Heading level={[3]} f={[3]}>
      Dether | Delete Sell Point
    </Heading>
  </Flex>
  }
  <DetherDeleteSellPointForm delta='unique' />
</Box>