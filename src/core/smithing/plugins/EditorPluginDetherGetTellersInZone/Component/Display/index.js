...
import DetherGetTellersInZoneForm from 'assimilation/fetching/dether/DetherGetTellersInZoneForm'
/* ---------------------------- Module Package ------------------------------ */
...
>
  ...
  <Flex align='center' >
    ...
    <Heading level={[3]} f={[3]}>
      Dether | Get Tellers In Zone
    </Heading>
  </Flex>
  }
  <DetherGetTellersInZoneForm delta='unique' />
</Box>