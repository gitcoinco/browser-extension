...
const FieldCollectionComponent = props => (
  <FieldCollectionWrapper direction={['column', 'row']} justify="space-evenly" {...props} >
    <Box flex='2 1 auto' {...props.fieldStyle}>
      <Field name="nameFirst" placeholder="First Name" component={ReduxField} type="text" height={35} {...props.fields} />
    </Box>
    <Box flex='3 1 auto' {...props.fieldStyle}>
      <Field name="nameLast" placeholder="Last Name" component={ReduxField} type="text" height={35} {...props.fields} />
    </Box>
